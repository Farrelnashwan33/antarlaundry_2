		...
		t = {
								...
								i
									? (r.options.preventSubmit && e.preventDefault(),
										...
										a.isFunction(r.options.submitError) &&
											r.options.submitError(t, e, n.jqBootstrapValidation('collectErrors', !0)))
									: (t.removeClass('error'),
										a.isFunction(r.options.submitSuccess) && r.options.submitSuccess(t, e)));
						}),
						this.each(function () {
							var t = a(this),
							...
							if (
								...
								(void 0 !== t.attr('maxlength') &&
									...
									void 0 !== t.attr('type') &&
										...
										t.data('validationNumberMessage') && (c = t.data('validationNumberMessage')),
									...
									void 0 !== t.attr('type') &&
										...
										t.data('validationValidemailMessage')
											...
											: t.data('validationEmailMessage') && (c = t.data('validationEmailMessage')),
							...
							(a.each(d, function (e, n) {
									...
									a.each(r.validatorTypes, function (e, r) {
										(void 0 === h[e] && (h[e] = []),
											s ||
												...
												(h[e].push(a.extend(!0, { name: i(r.name), message: o }, r.init(t, n))),
												(s = !0)));
									}),
									...
									'shortcut' === c
										...
										: a.each(r.validatorTypes, function (e, o) {
												(void 0 === h[e] && (h[e] = []),
													s ||
														c !== e.toLowerCase() ||
														(t.data('validation' + n + i(o.name), d[o.name.toLowerCase()]),
								...
								l.data(
									'original-contents',
									l.data('original-contents') ? l.data('original-contents') : l.html()
								),
								l.data(
									'original-role',
									l.data('original-role') ? l.data('original-role') : l.attr('role')
								),
								o.data(
									'original-classes',
									o.data('original-clases') ? o.data('original-classes') : o.attr('class')
								),
								t.data(
									...
									return (
										a.each(h, function (e, n) {
											(o ||
												o.length ||
												(i && i.includeEmpty) ||
												(r.validatorTypes[e].blockSubmit && i && i.submitting)) &&
						...
						this.each(function (t, i) {
							e = e.concat(
								a(i).triggerHandler('getValidators.validation')
									? a(i).triggerHandler('validation.validation', { submitting: !0 })
									: []
							);
						}),
						e.length > 0
			...
			validatorTypes: {
				...
				maxlength: {
					...
					validate: function (a, e, t) {
						return (
							(e.length > t.maxlength && !t.negative) || (e.length <= t.maxlength && t.negative)
						);
					}
				},
				minlength: {
					...
					validate: function (a, e, t) {
						return (
							(e.length < t.minlength && !t.negative) || (e.length >= t.minlength && t.negative)
						);
					}
				},
				maxchecked: {
