...
<div class="flex h-screen w-full flex-col overflow-hidden bg-[#f4f7f6] font-sans text-surface-900">
	...
	<div class="relative flex flex-1 overflow-hidden">
		...
		<nav class="fixed inset-x-0 bottom-0 z-50 flex items-center justify-around border-t border-surface-200 bg-white px-2 py-2 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] md:hidden">
			<!-- Beranda -->
			<a href="/admin" class="flex w-16 flex-col items-center justify-center gap-1.5 transition-colors {$page.url.pathname === '/admin' ? 'text-blue-600' : 'text-surface-500 hover:text-surface-700'}">
			...
			<!-- Orders -->
			<a href="/admin/orders" class="flex w-16 flex-col items-center justify-center gap-1.5 transition-colors {$page.url.pathname === '/admin/orders' ? 'text-blue-600' : 'text-surface-500 hover:text-surface-700'}">
				<svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width={$page.url.pathname === '/admin/orders' ? '2.5' : '2'} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
				<span class="text-[11px] leading-none font-medium">Orders</span>
			</a>

			<!-- New -->
			<a href="/admin/orders/new" class="flex w-16 flex-col items-center justify-center gap-1.5 transition-colors {$page.url.pathname === '/admin/orders/new' ? 'text-blue-600' : 'text-surface-500 hover:text-surface-700'}">
			...
			<!-- Go Laundry -->
			<a href="/admin/golaundry/orders" class="flex w-16 flex-col items-center justify-center gap-1.5 transition-colors {$page.url.pathname === '/admin/golaundry/orders' ? 'text-blue-600' : 'text-surface-500 hover:text-surface-700'}">
			...
			<!-- Customers -->
			<a href="/admin/customers" class="flex w-16 flex-col items-center justify-center gap-1.5 transition-colors {$page.url.pathname === '/admin/customers' ? 'text-blue-600' : 'text-surface-500 hover:text-surface-700'}">
