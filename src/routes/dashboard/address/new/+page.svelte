...
<svelte:head>
  <title>Tambah Alamat - Antar Laundry</title>
</svelte:head>
...
<div class="max-w-2xl mx-auto p-6 lg:p-10">
  <div class="mb-8">
    ...
    <h1 class="text-3xl font-extrabold text-surface-900 tracking-tight">Tambah Alamat Baru</h1>
    <p class="text-surface-500 mt-1">Masukkan detail alamat untuk penjemputan dan pengantaran</p>
  </div>
