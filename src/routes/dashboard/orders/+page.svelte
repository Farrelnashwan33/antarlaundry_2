...
<div class="p-6 lg:p-10">
  <div class="flex justify-between items-center mb-8">
    <div>
      <h1 class="text-3xl font-extrabold text-surface-900 tracking-tight">Pesanan Saya</h1>
      <p class="text-surface-500 mt-1">Daftar semua pesanan laundry Anda</p>
    </div>
  </div>
  ...
  <div class="bg-white border border-surface-200 rounded-3xl p-6 shadow-sm">
    {#if orders?.length === 0}
      <div class="text-center py-12">
        ...
        <h3 class="text-xl font-bold text-surface-900 mb-2">Belum ada pesanan</h3>
        <p class="text-surface-500 mb-6">Anda belum pernah membuat pesanan sebelumnya.</p>
        <a href="/dashboard/order/new" class="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-xl hover:bg-blue-700 transition-colors shadow-md shadow-blue-500/20">Buat Pesanan Pertama</a>
      </div>
    {:else}
