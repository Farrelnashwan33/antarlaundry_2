<script lang="ts">
  ...
  const navItems = [
    ...
    { name: 'Store', path: '/courier/store', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
...
<div class="flex flex-col h-screen w-full overflow-hidden bg-[#f4f7f6] font-sans text-surface-900">
  ...
  <header class="hidden md:flex h-14 bg-[#0f172a] text-white items-center justify-between px-6 shrink-0 z-30">
    ...
    <div class="flex items-center gap-4">
      <a href="/courier" class="text-slate-400 hover:text-white transition-colors" title="Settings" aria-label="Settings">
